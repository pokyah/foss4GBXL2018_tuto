...
elevation = elevatr::get_elev_raster(as(wallonia, "Spatial"), z = 9, src = "aws")
class(elevation)
# checking CRS
...
extraction = dplyr::select(extraction, altitude)
head(extraction)
plot(extraction)
...
> Retrieving admin boundaries of the interest zone

```{r adminBoundaries, exercise=TRUE}
# downloading admin boundaries of Belgium
